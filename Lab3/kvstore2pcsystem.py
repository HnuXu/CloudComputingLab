...
def get_value(s,s_connect_participant,participants,par_num):
    global three_ok  
...
if ROLE==0:
    ...
    p_mainThread=threading.Thread(target=p_get_value,args=(s,KV_Store,))
    p_mainThread.start()
    ...
    mainThread=threading.Thread(target=get_value,args=(s,s_connect_participant,participants,par_num,))
    mainThread.start()
